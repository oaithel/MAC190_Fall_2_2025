...
public class Tesla extends Vehicle implements iDrive{
    ...
    public Tesla(){
        super("Tesla", "N/A", "Electric");
        model = "N/A";
        color = "N/A";
        seats = 0;
    }
    public Tesla(String v, String m, String c, int s){
        super("Tesla", "N/A", "Electric");
        model = m;
        color = c;
        seats = s;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Tesla ts)) return false;
        if (!super.equals(o)) return false;
        return seats == ts.seats && Objects.equals(model, ts.model) && Objects.equals(color, ts.color);
    }
    @Override
